...
(function () {
    ...
    const CONFIG = {
        ...
        containerId: 'ad-network-wrapper'
    };
    ...
    function injectStyles() {
        ...
        style.innerHTML = `
            #${CONFIG.containerId} {
                ...
                width: auto;
                height: auto;
                z-index: 2147483647; /* Máximo z-index posible en los navegadores */
                pointer-events: none; /* No bloquear clicks sobre el espacio vacío */
                display: flex;
            ...
            .ad-net-content {
                ...
                width: 100%;
                max-width: 120px; /* Tamaño máximo fijado por requerimiento */
                padding-top: 10px;
                padding-right: 10px;
            }
            .ad-net-link {
            ...
            .ad-net-iframe {
                border: none;
                width: 140px; /* Ancho extra para dar espacio al botón de cerrar */
                height: 50px; /* Altura inicial pequeña, se ajusta mediante postMessage */
                background: transparent;
                overflow: hidden;
            }
        `;
    ...
    async function initAdNetwork() {
        try {
            ...
            // Construir ruta absoluta hacia la carpeta del idioma (ej: 'https://dinamic-56d.pages.dev/es/ad.json')
            const dynamicApiUrl = `${CONFIG.baseUrl}/${adLang}/ad.json`;
